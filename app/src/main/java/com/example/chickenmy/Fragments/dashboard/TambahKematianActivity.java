...
import com.example.chickenmy.Fragments.settings.SettingKipasActivity;
...
public class TambahKematianActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_kematian_simpan) {
            if (!edtKematianAyam.getText().toString().equals("")) {
                db.GrafikGrid
                ...
                Toast.makeText(TambahKematianActivity.this, "Masukan Jumlah Kematian Ayam",
